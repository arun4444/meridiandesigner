...
(function () {
    ...
    function addGUI () {
        ...
        Object.keys(layer.scene.config.layers).forEach(function(l) {
            if (!layer.scene.config.layers[l] || layer.scene.config.layers[l].data.layer === 'earth' || layer.scene.config.layers[l].data.layer === 'water') {
                return;
            }
			
			console.log(layer.scene.config.layers[l].data.layer);
